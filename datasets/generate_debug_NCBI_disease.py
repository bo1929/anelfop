...
with open(
    tokenized_data_dir + "debug_NCBI_disease_train.tokenized", "w"
) as fp:  # serializing
    json.dump(tokenized[0][0][:50], fp)
with open(
    tokenized_data_dir + "debug_NCBI_disease_train.tags", "w"
) as fp:  # serializing
    json.dump(tokenized[0][1][:50], fp)

with open(
    tokenized_data_dir + "debug_NCBI_disease_test.tokenized", "w"
) as fp:  # serializing
    json.dump(tokenized[1][0][:50], fp)
with open(
    tokenized_data_dir + "debug_NCBI_disease_test.tags", "w"
) as fp:  # serializing
