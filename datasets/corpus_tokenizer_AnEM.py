...
with open(tokenized_data_dir + "AnEM_train.tokenized", "w") as fp:  # serializing
    json.dump(tokenized[0][0], fp)
with open(tokenized_data_dir + "AnEM_train.tags", "w") as fp:  # serializing
    json.dump(tokenized[0][2], fp)

with open(tokenized_data_dir + "AnEM_test.tokenized", "w") as fp:  # serializing
    json.dump(tokenized[1][0], fp)
with open(tokenized_data_dir + "AnEM_test.tags", "w") as fp:  # serializing
