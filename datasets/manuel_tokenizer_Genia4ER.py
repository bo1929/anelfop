...
with open(tokenized_data_dir + "Genia4ER_train.tokenized", "w") as fp:  # serializing
    json.dump(tokenized[0][0], fp)
with open(tokenized_data_dir + "Genia4ER_train.tags", "w") as fp:  # serializing
    json.dump(tokenized[0][1], fp)

with open(tokenized_data_dir + "Genia4ER_test.tokenized", "w") as fp:  # serializing
    json.dump(tokenized[1][0], fp)
with open(tokenized_data_dir + "Genia4ER_test.tags", "w") as fp:  # serializing
