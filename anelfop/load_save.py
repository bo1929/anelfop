...
def load_data(cfg):
    ...
    tknzd_sent_test = []
    with open(cfg["data_directory"] + name + "_devel.tokenized") as tokenized_file:
        tknzd_sent_test = json.load(tokenized_file)

    tags_test = []
    with open(cfg["data_directory"] + name + "_devel.tags") as tags_file:
    ...
    if cfg["data_set"]["pos"]:
        ...
        pos_tags_test = []
        with open(cfg["data_directory"] + name + "_devel.pos") as pos_file:
